            ...
            <div className="w-full max-w-6xl overflow-hidden rounded-3xl bg-white shadow-2xl ring-1 ring-black/10 lg:grid lg:grid-cols-2">
                <div className="relative hidden overflow-hidden bg-gradient-to-br from-black via-zinc-900 to-zinc-800 px-10 text-white lg:flex xl:px-16">
                    <div className="relative z-10 flex flex-col justify-start pt-14 xl:pt-16">
                        <h1 className="mt-4 max-w-md text-4xl xl:text-5xl font-normal leading-tight">
                            Discover fashion that defines your style, all in one place.
                        </h1>
                        <p className="mt-4 max-w-md text-base xl:text-lg text-zinc-300 font-light tracking-wide">
                            Shop permium clothing collections with a seamless shopping experience.
                        </p>
                    </div>
                    ...
                    <img
                        className="absolute inset-x-0 inset-y-40 bottom-0 z-10 h-[78%] w-full scale-120 object-contain object-bottom px-6 xl:px-10 xl:scale-205"
                        src={Login3d}
                        alt="3D Login"
                    />
                </div>
                ...
                <div className="flex flex-col justify-center px-6 py-10 sm:px-10 lg:px-14">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <h1 className="mt-4 text-2xl sm:text-3xl font-normal text-slate-900">StyleHub</h1>
