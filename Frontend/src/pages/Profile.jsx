      ...
      {isLoggedIn ? (
        <div className="max-w-7xl mx-auto mt-6">
          ...
          <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-3">
            ...
            <p className="text-center text-gray-500 mt-1">{user.email}</p>
          </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mt-8">
              ...
              {user.addresses?.length > 0 ? (
                <div className="space-y-4">
                  {user.addresses.map((address, index) => (
                    ...
                    >
                      <h3 className="font-bold mb-3">Address #{index + 1}</h3>
            ...
            {(showAddressForm ||
              ...
              user.addresses.length === 0) && (
              <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-6">
                <h2 className="text-xl font-bold mb-5">Add Address</h2>
