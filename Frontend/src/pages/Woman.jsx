...
function Man() {
  ...
  return (
    <div className="min-h-screen px-4 md:px-6 py-6 bg-gray-50">
        ...
        <div className="flex items-center justify-between min-h-[180px] md:min-h-[240px] lg:min-h-[300px] px-5 md:px-10 lg:px-14">
          <div className="z-10 max-w-[60%] md:max-w-[45%]">
            ...
            <p className="text-gray-500 text-sm md:text-base lg:text-lg">
              Explore our exclusive collection of women's fashion, featuring the
              latest trends and timeless classics. From casual wear to formal
              attire, find the perfect pieces to elevate your style.
            </p>
          </div>
      ...
      {/* Divider */}
      <div className="h-px w-full  bg-gradient-to-r from-transparent via-gray-300 to-transparent mt-6"></div>
